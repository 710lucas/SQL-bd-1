...
-- c) Quais os nomes e sal�rios dos funcion�rios do sexo masculino que realizaram pedidos no ano de 2020
-- e 2021? (sub-consulta obrigat�ria)
...
-- d) Quais os nomes dos produtos que foram comprados por clientes pessoa f�sica no ano de 2022? (sub-
...
-- g) Mostre as datas dos pedidos que tiveram produtos com pre�o de venda maior que R$ 200 e do tipo
-- Cama ou Eletro.
select * from Tipo
...
-- h) Quais os distintos nomes dos produtos vendidos cujo pre�o de venda seja maior do que a m�dia dos
-- pre�os de vendas dos produtos.
